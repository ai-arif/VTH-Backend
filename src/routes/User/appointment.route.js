...
import {
  appointmentSSLPayment,
  appointmentSSLPaymentFail,
  appointmentSSLPaymentSuccess,
...
// payment apis
appointmentRouter.get("/payment/success/:id", appointmentSSLPaymentSuccess);
appointmentRouter.get("/payment/fail/:id", appointmentSSLPaymentFail);
